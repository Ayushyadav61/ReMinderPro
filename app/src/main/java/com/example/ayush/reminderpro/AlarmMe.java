...
public class AlarmMe extends Activity {
    ...
    Button add_alarm = (Button)findViewById(R.id.add_alarm);
    add_alarm.setOnLongClickListener(new Button.OnLongClickListener(){
    public boolean onLongClick(View v) {
        Intent i= new Intent(AlarmMe.this, MainActivity.class);
...
//    mAlarmListAdapter.save();
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        else if(R.id.menu_vault == item.getItemId())
        {
